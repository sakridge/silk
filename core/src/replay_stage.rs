...
impl ReplayStage {
        ...
        let t_replay = Builder::new()
            ...
            .spawn(move || {
                ...
                loop {
                    ...
                    debug!("tpu_has_bank {}", tpu_has_bank);
                    ...
                    debug!("done votable: {}", tpu_has_bank);
                    if !tpu_has_bank {
    ...
    fn maybe_start_leader(
        ...
        debug!("{} reached_leader_tick", my_pubkey,);
